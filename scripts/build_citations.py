...
DOMAIN = {
 "coding": "swe-bench-verified swe-bench-pro swe-bench-multilingual swe-bench-multimodal terminal-bench frontiercode frontier-swe programbench cursorbench vibench livecodebench aider-polyglot codeforces ojbench expert-swe spreadsheetbench minimal-linuxbench mle-bench frontierbench".split(),
