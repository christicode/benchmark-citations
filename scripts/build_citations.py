...
DOCS={
 ...
 "gemini3":dict(lab="google_deepmind",model="Gemini 3 Pro",dt="blog_headliner",date="2025-11-18",
   ...
   b=["GPQA Diamond","HLE","ARC-AGI-2","MathArena","MMMU-Pro","Video-MMMU","SimpleQA","AIME","Vending-Bench 2","SWE-bench Verified","Terminal-Bench 2.0","WebDev Arena"]),
}
...
SCORES={
 ...
 ("gemini3","swe-bench-verified"):(76.2,"percent","Gemini 3 Pro"),("gemini3","terminal-bench"):(54.2,"percent","Gemini 3 Pro (Terminal-Bench 2.0)"),
...
NEWDOCS={
 ...
 "opus47":dict(lab="anthropic",model="Claude Opus 4.7",dt="system_card",date="2026-04-16",
   ...
   b=["SWE-bench Verified","Terminal-Bench","GPQA","AIME","ARC-AGI","MMLU","BrowseComp","HLE","DeepSearchQA","GDPval-AA","OSWorld","Vending-Bench","CharXiv","LAB-Bench","FigQA","MASK","SHADE","Petri","Cybench","CyberGym","BioMysteryBench","Minimal-LinuxBench","SimpleQA","MathArena","USAMO","BioPipelineBench","OfficeQA"]),
 ...
 "gpt56card":dict(lab="openai",model="GPT-5.6 Sol",dt="system_card",date="2026-06-26",
   ...
   b=["HealthBench","CVE-Bench","ProtocolQA","TroubleshootingBench","GPQA","MMLU-Pro","HLE","BFCL","SWE-bench Verified","MLE-Bench","CyberGym","CyScenarioBench","ExploitBench"]),
